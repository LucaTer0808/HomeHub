...
/**
 * <p>The InvitationId class represents a composite primary key for identifying
 * the association between a user and a household in a database before the user joined the Household.</p>
 *
